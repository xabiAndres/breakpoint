...
class DataService {
    ...
    func getUsername(fourUID uid: String, handler: @escaping(_ username: String) -> ()) {
    ...
    func updloadPost(withMessage message: String, forUID uid: String, withGroupKey groupKey: String?, sendComplete: @escaping (_ status: Bool) -> ()) {
        if groupKey != nil {
    ...
    func gettAllMessagesFor(desiredGroup: Group, handler: @escaping (_ messagesArray: [Message]) -> ()) {
